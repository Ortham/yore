  ...
  test('handleFilterToggle should call getFilteredPhotos if the filter is enabled', () => {
    ...
    return pageInstance
      ...
      .then(() => {
        ...
        expect(pageInstance.state.photos[0].path).toEqual(photos[1].path);
        expect(pageInstance.state.photos[0].location).toEqual({
          Existing: {
            latitude: 5,
            longitude: 30
          }
  ...
  test('handleFilterToggle should call set full photos array if the filter is disabled', () => {
    ...
    return pageInstance
      ...
      .then(() => {
        ...
        expect(pageInstance.state.filterPhotos).toBe(false);
        expect(pageInstance.state.photos).not.toEqual(photos);
        ...
        expect(pageInstance.state.photos[1].path).toBe(photos[1].path);
